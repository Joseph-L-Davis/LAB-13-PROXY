...
import { formatLocation, formatWeather } from './utils.js';
...
app.get('/weather', async (req, res) => {
  try {
    const response = await request.get(`https://api.weatherbit.io/v2.0/forecast/daily?&lat=38.123&lon=-78.543&key=${process.env.WEATHER_API_KEY}`);
